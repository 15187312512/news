...
function printDataToPage(data){
     ...
     var s="<ul class='fly-list'>"
      $.each(data,function(v,bean){
      				...
      				s+="<li><h2>";
      				s+="<a class='layui-badge'>"+bean.lanmu.lanmuming+"</a>";
      				s+="<a href='wangzhanmethod!showcontent.action?id="+bean.id +"'>";
      				s+=bean.title+"</a></h2>";
                    s+="<div class='fly-list-info'>";
                    s+="<cite>发布时间：</cite>";
                    s+="<span>"+date+"</span>";
                    s+="<span class='fly-list-nums'>";
                    s+="<i class='iconfont' title='人气'>&#xe60b;</i>"+bean.dianjicishu+"</span></div>";
                    s+="</li>";
...
/* 请求数据 */
 function getIndexPage(obj){
            ...
            $.ajax({
                ...
                async:false,
                scriptCharset: 'utf-8',
                url:"pagemethod!pageForIndex.action",
                data:{curPage:obj.curr, limt:obj.limit,columnId:columnId},
