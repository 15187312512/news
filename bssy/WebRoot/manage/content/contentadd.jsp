...
<form method="post" name=form1 action="houtaimethod!contentadd2.action" class="pageForm" onsubmit="return check(this,dialogAjaxDone);">
	...
	<div class="pageFormContent nowrap" layoutH="80">
				...
				<label>所属栏目:</label>
				 ...
				 <c:forEach items="${list}" var="bean">
				  <option value="${bean.id }">${bean.lanmuming }</option>
				 </c:forEach>
